...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](KING-USER1/DRAGON-USERBOT)**",
        ...
        "__INFO:DragonBot:Logged in as 557667062__",
        "__INFO:DragonBot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
